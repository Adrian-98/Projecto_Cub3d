...
/*   Updated: 2020/01/14 18:06:15 by amunoz-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (cub->matrix[(int)(cub->posX + cub->dirX * cub->movespeed)][(int)cub->posY] == 0)
		cub->posX = cub->posX + cub->dirX * cub->movespeed;
	if (cub->matrix[(int)cub->posX][(int)(cub->posY + cub->dirY * cub->movespeed)] == 0)
...
static void	ft_walk_left(t_cub *cub)
{
	if (cub->matrix[(int)(cub->posX - cub->dirY * cub->movespeed)][(int)cub->posY] == 0) 
		cub->posX = cub->posX - cub->dirY * cub->movespeed;
	if (cub->matrix[(int)cub->posX][(int)(cub->posY + cub->dirX * cub->movespeed)] == 0)
		cub->posY = cub->posY + cub->dirX * cub->movespeed;
}

static void	ft_walk_right(t_cub *cub)
{
	if (cub->matrix[(int)(cub->posX + cub->dirY * cub->movespeed)][(int)cub->posY] == 0) 
		cub->posX = cub->posX + cub->dirY * cub->movespeed;
	if (cub->matrix[(int)cub->posX][(int)(cub->posY - cub->dirX * cub->movespeed)] == 0)
